...
namespace SellerProcessingService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IHostedService, BidDataService>();
            services.AddSingleton<IMongoDBContext, MongoDBContext>();
            services.AddSingleton<IProductRepository, ProductRepository>();
            services.AddSingleton<IBuyerRepository, BuyerRepository>();
            services.AddSingleton<ISellerBusinessManager, SellerBusinessManager>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SellerProcessingService", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "SellerProcessingService v1"));
            }
